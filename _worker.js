...
* Last Update: 4:20 UTC - Thursday, 19 September 2024, By POORIAREDORG
* Many thanks to github.com/bia-pain-bache
*/
import { connect } from 'cloudflare:sockets';
// How to generate your own UUID:
// https://www.uuidgenerator.net/
let userID = '53fa8faf-ba4b-4322-9c69-a3e5b1555049';
...
function generateRemark(index, port, protocol, fragType) {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `POORIA⇢${protocol}${type} ⇢Ðoϻɑiͷ  ${index + 1} ⇢${port}`;
            break;
        case 2:
        case 3:
            remark = `POORIA⇢${protocol}${type} ⇢IPV4 ${index - 1} ⇢${port}`;
            break;
        case 4:
        case 5:
            remark = `POORIA⇢${protocol}${type} ⇢IPV6 ${index - 3} ⇢${port}`;
            break;
        default:
            remark = `POORIA⇢${protocol}${type} ⇢CLEAN IP ${index - 5} ⇢${port}`;
            break;
    }
...
async function renderHomePage (env, hostName, fragConfigs) {
	...
	<head>
        ...
        <title>POORIA panel ${panelVersion}</title>
	...
	<body>
		<h1>POORIA control panel <span style="font-size: smaller;">${panelVersion}</span> 👻</h2>
			...
			<div class="table-container">
				<table id="normal-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/sub/${userID}#POORIA-Normal', 'Normal Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code_2</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}#POORIA-Normal', false)">
					...
					<tr>
						...
						<td>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}?app=singbox#POORIA-Normal', false)">
                                Copy Sub<span class="material-symbols-outlined">subject</span>
                            </button>
						</td>
					</tr>
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('sing-box://import-remote-profile?url=https://${hostName}/sub/${userID}?app=sfa#POORIA-Normal', 'Normal Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code_2</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}?app=sfa#POORIA-Normal', false)">
                                Copy Sub<span class="material-symbols-outlined">subject</span>
                            </button>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/sub/${userID}?app=clash#POORIA-Normal', 'Normal Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code_2</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/${userID}?app=clash#POORIA-Normal', false)">
                                Copy Sub<span class="material-symbols-outlined">subject</span>
                            </button>
                        </td>
                    </tr>
			...
			<div class="table-container">
                <table id="frag-sub-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/fragsub/${userID}#POORIA Fragment', 'Fragment Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code_2</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/fragsub/${userID}#POORIA Fragment', true)">
                                Copy Sub<span class="material-symbols-outlined">subject</span>
                            </button>
                        </td>
                    </tr>
			...
			<div class="table-container">
				<table id="normal-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/warpsub/${userID}?app=xray#POORIA-Warp', 'Warp Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code_2</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=xray#POORIA-Warp', false)">
                                Copy Sub<span class="material-symbols-outlined">subject</span>
                            </button>
                        </td>
					</tr>
					<tr>
						...
						<td>
                            <button onclick="openQR('sing-box://import-remote-profile?url=https://${hostName}/warpsub/${userID}?app=singbox#POORIA-Warp', 'Warp Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code_2</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=singbox#POORIA-Warp', false)">
                                Copy Sub<span class="material-symbols-outlined">subject</span>
                            </button>
						</td>
					</tr>
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/warpsub/${userID}?app=clash#POORIA-WARP', 'Warp Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code_2</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=clash#POORIA-WARP', false)">
                                Copy Sub<span class="material-symbols-outlined">subject</span>
                            </button>
                        </td>
                    </tr>
			...
			<div class="table-container">
				<table id="warp-pro-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/warpsub/${userID}?app=nikang#POORIA-Warp-Pro', 'Warp Pro Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code_2</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=nikang#POORIA-Warp-Pro', false)">
                                Copy Sub<span class="material-symbols-outlined">subject</span>
                            </button>
                        </td>
					</tr>
					<tr>
						...
						<td>
                            <button onclick="openQR('sing-box://import-remote-profile?url=https://${hostName}/warpsub/${userID}?app=hiddify#POORIA-Warp-Pro', 'Warp Pro Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code_2</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}?app=hiddify#POORIA-Warp-Pro', false)">
                                Copy Sub<span class="material-symbols-outlined">subject</span>
                            </button>
						</td>
					</tr>
...
async function renderLoginPage () {
    ...
    <body>
        <div class="container">
            <h1>Hi 👻 <br><span style="font-size: smaller;">Your welcome to POORIA</span> </h3>
            <div class="form-container">
                <h2>User Login</h2>
                <form id="loginForm">
                    <div class="form-control">
...
function renderErrorPage (message, error, refer) {
    ...
    <body>
        <div id="error-container">
            <h1>POORIA Panel <span style="font-size: smaller;">${panelVersion}</span> 👻</h2>
...
async function getFragmentConfigs(env, hostName, client) {
    ...
    bestPing.remarks = '☆POORIA Fragment Best Ping';
    ...
    bestFragment.remarks = '★POORIA Fragment Best Values';
